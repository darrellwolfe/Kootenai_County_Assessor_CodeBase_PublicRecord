...
Changes
Parcel Master A and I

MH must include M and D, A and I
...
---------------------------
  ...
  (tr.SalePrice/commsf.[CommSF]) AS [SalePrice_$/SF],
  commsfMSale.[CommBldMultiSaleSF],
  (COALESCE(msv.[MultiSale_TotalSums], 0) / commsfMSale.[CommBldMultiSaleSF]) AS [MultiSalePrice_$/SF],
