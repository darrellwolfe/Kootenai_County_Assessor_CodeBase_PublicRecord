...
Declare @MemoLastUpdatedNoEarlierThan DATE = '2023-01-01';
--1/1 of the earliest year requested. 
-- If you need sales back to 10/01/2022, use 01/01/2022

--Declare @MemoLastUpdatedNoLaterThan DATE = '2023-12-31';
...
CTE_DocCounts AS (
  ...
  WHERE status = 'A'
    ...
    AND pxfer_date BETWEEN '2023-01-01' AND '2023-12-31'
  GROUP BY DocNum
),
...
,cv23.Cert_Imp
,cv23.Cert_Total
,wsv.Worksheet_Imp AS WorksheetValue_TOS_ImpValue
...
JOIN CTE_WorksheetMarketValues AS wsv
  ON tr.lrsn=wsv.lrsn
