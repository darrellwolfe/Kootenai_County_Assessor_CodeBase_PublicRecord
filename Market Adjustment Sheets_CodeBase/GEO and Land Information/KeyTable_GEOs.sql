...
SELECT
'Manufactured_Homes' AS District, -- or provide a suitable value
'MH_Sales_InResGeos' AS District_SubClass, -- or provide a suitable value
'9999' AS GEO,
'MH_in_Res' AS GEO_Name,
0 AS Parcels_In_GEO


Order By District, District_SubClass, GEO;
