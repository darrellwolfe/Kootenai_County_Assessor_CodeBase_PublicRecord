...
DECLARE @LastYearCertFrom INT = '20230101';
DECLARE @LastYearCertTo INT = '20231231';

--Change first four digits to this year for both
DECLARE @Jan1ThisYear1 DATETIME;
SET @Jan1ThisYear1 = '2024-01-01 00:00:00';

DECLARE @Jan1ThisYear2 DATETIME;
SET @Jan1ThisYear2 = '2024-01-01 23:59:59';



DECLARE @ThisYearCertFrom INT = '20240101';
DECLARE @ThisYearCertTo INT = '20241231';

DECLARE @ThisYearMPPVFrom INT = '202400000';
DECLARE @ThisYearMPPVTo INT = '202499999';

DECLARE @CadasterYear INT = '2024';
*/
...
AND pmd.PIN NOT LIKE 'U%'
AND pmd.PIN NOT LIKE 'G%'
