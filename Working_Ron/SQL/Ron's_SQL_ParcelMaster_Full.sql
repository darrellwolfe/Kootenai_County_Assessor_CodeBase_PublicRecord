CREATE INDEX idx_effstatus ON TSBv_PARCELMASTER(EffStatus);
CREATE INDEX idx_classcd ON TSBv_PARCELMASTER(ClassCD);
CREATE INDEX idx_neighborhood ON TSBv_PARCELMASTER(neighborhood);
CREATE INDEX idx_countynumber ON TSBv_PARCELMASTER(CountyNumber);
