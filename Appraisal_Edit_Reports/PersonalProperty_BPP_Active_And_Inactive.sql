...
DECLARE @LastYearCertFrom BIGINT = CAST(CONCAT(@Year - 1, '0101') AS BIGINT);
DECLARE @LastYearCertTo BIGINT = CAST(CONCAT(@Year - 1, '1231') AS BIGINT);
DECLARE @ThisYearCertFrom BIGINT = CAST(CONCAT(@Year, '0101') AS BIGINT);
DECLARE @ThisYearCertTo BIGINT = CAST(CONCAT(@Year, '1231') AS BIGINT);
...
DECLARE @ThisYearMPPVFrom BIGINT = CONCAT(@Year, '00000');
DECLARE @ThisYearMPPVTo BIGINT = CONCAT(@Year, '99999');
