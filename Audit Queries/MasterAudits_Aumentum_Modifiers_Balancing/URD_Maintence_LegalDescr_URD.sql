...
,fnd.TAG
,CASE
  WHEN fnd.LegalDescription LIKE '%URD%' THEN 'URDDescr'
  ELSE ''
 END AS 'IfURD'

,fnd.LegalDescription
...
Where fnd.LegalDescription LIKE '%URD%'
And fnd.LegalDescription NOT LIKE '%OUTSIDE%'
And fnd.LegalDescription NOT LIKE '%NOT IN%'
