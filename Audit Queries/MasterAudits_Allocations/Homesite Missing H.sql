...
Select Distinct
a.lrsn
,CONCAT(TRIM(a.group_code), ' |  ', TRIM(c.tbl_element_desc)) AS GroupCodes
,TRIM(a.group_code) AS GroupCode
,TRIM(c.tbl_element_desc) AS GroupCodeDescription
