...
--Current Year
,FORMAT(fnd.TotalLand, 'C', 'en-US') AS TotalLand
,FORMAT(fnd.TotalImp, 'C', 'en-US') AS TotalImp
,FORMAT(fnd.TotalHOEX, 'C', 'en-US') AS TotalHOEX
,FORMAT(fnd.TotalAssessed, 'C', 'en-US') AS TotalAssessed
,FORMAT((fnd.TotalAssessed - fnd.TotalHOEX), 'C', 'en-US') AS NetAssessedAfterHOEX
,FORMAT((fnd.TotalNetTaxable), 'C', 'en-US') AS TotalNetTaxable

,'PreviousYear' AS PreviousYear
--Previous Year
,FORMAT(fnd.TotalLandLastYear, 'C', 'en-US') AS TotalLandLastYear
,FORMAT(fnd.TotalImpLastYear, 'C', 'en-US') AS TotalImpLastYear
,FORMAT(fnd.TotalAssessedLastYear, 'C', 'en-US') AS TotalAssessedLastYear
,'AmountDiff' AS AmountDiff
,FORMAT((fnd.TotalLandLastYear - fnd.TotalImpLastYear), 'C', 'en-US') AS DiffLand_YearOverYear
,FORMAT((fnd.TotalImp - fnd.TotalImpLastYear), 'C', 'en-US') AS DiffImp_YearOverYear
,FORMAT((fnd.TotalAssessed - fnd.TotalAssessedLastYear), 'C', 'en-US') AS DiffTotal_YearOverYear
,'PercOfChange' AS PercOfChange
,FORMAT((fnd.TotalLandLastYear / NULLIF(fnd.TotalImpLastYear,0)), 'P2') AS PercChange_Land_YearOverYear
,FORMAT((fnd.TotalImp / NULLIF(fnd.TotalImpLastYear,0)), 'P2') AS PercChange_Imp_YearOverYear
,FORMAT((fnd.TotalAssessed / NULLIF(fnd.TotalAssessedLastYear,0)), 'P2') AS PercChange_Total_YearOverYear
