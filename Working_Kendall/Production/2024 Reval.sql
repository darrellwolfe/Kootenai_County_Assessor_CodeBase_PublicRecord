...
SELECT 
  tc.neighborhood,
  COUNT(cf.collection_date) AS [Fielded Count],
  COUNT(cc.appraisal_date) AS [Appraised Count],
  COUNT(ry.memo_text) AS [Memos Entered],
...
GROUP BY tc.neighborhood,
tc.[Total Parcel Count]

ORDER BY tc.neighborhood
