...
LEFT JOIN CTE_DescrHeader AS dd 
  ON pb.lrsn=dd.RevObjId
  AND dd.RowNum = 1

LEFT JOIN CTE_MFDetails AS mfd 
  ON kcv.lrsn=mfd.lrsn
LEFT JOIN CTE_FncDetails AS fndl 
  ON kcv.lrsn=fndl.RevObjId
