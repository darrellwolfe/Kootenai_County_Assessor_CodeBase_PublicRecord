Sub CopyRowsByGeoCode()
    ...
    Set sourceWorksheet = sourceWorkbook.Sheets("MH_FloatRes_Template")
    ...
    For wsIndex = 1 To ThisWorkbook.Sheets.Count
        If ThisWorkbook.Sheets(wsIndex).Name = "1000" Then 
    ...
    For wsIndex = startWsIndex To ThisWorkbook.Sheets.Count
        ...
        For i = 2 To sourceLastRow
            ...
            If targetWorksheet.Cells(1, 2).Value = geoCode Then
                ...
                sourceWorksheet.Range("C" & i & ":AE" & i).Copy
                targetWorksheet.Cells(targetRow, 1).PasteSpecial xlPasteValues
                sourceWorksheet.Cells(i, 32).Copy
                targetWorksheet.Cells(targetRow, 40).PasteSpecial xlPasteValues
                sourceWorksheet.Cells(i, 33).Copy
                targetWorksheet.Cells(targetRow, 41).PasteSpecial xlPasteValues
