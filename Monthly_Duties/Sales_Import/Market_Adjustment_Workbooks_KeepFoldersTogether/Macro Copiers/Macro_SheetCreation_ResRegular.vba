Sub CopySheetWithNewNames()
    ...
    Set ws = wb.Sheets("RES_REG_TEMPLATE")  ' Changed from an index to a sheet name
    ...
    ' Check if the cell in column A is "District_1" AND the cell in column B is "Res_Sales" <<Check underscore District_1 not District 1
    
    If wsNames.Cells(i, "A").Value = "District_1" And wsNames.Cells(i, "B").Value = "Res_Sales" Then
