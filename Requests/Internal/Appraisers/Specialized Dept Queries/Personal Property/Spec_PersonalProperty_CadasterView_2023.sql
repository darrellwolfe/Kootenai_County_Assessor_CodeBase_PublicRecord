...
2023 Annual Real Property
CadRoll.id = 559

2022 PERSONAL PROPERTY 2
CadRoll.id = 558

2023 Annual Personal Property
CadRoll.id = 560
...
WHERE
    ...
    AND cv.ValueTypeShortDescr IN ('Net Tax Value', 'PP_Exemption', 'PP Assessed')
...
--,'2022','2021','2020','2019','2018','2017','2016','2015','2014','2013')
    AND (cv.ValueTypeShortDescr = 'Net Taxable Value'
        OR cv.ValueTypeShortDescr = 'PP_Exemption'
        OR cv.ValueTypeShortDescr = 'PP Assessed'
        )
/*
JOIN CadValueTypeAmount_V AS cvnt ON pm.lrsn = cvnt.RevObjId
  AND cvnt.ValueTypeShortDescr = 'Net Taxable Value'
  AND cvnt.AssessmentYear IN ('2023')
--,'2022','2021','2020','2019','2018','2017','2016','2015','2014','2013')

JOIN CadValueTypeAmount_V AS cvpx ON pm.lrsn = cvpx.RevObjId
  AND cvpx.ValueTypeShortDescr = 'PP_Exemption'
  AND cvpx.AssessmentYear IN ('2023')
--,'2022','2021','2020','2019','2018','2017','2016','2015','2014','2013')

JOIN CadValueTypeAmount_V AS cvas ON pm.lrsn = cvas.RevObjId
  AND cvas.ValueTypeShortDescr = 'PP Assessed'
  AND cvas.AssessmentYear IN ('2023')
--,'2022','2021','2020','2019','2018','2017','2016','2015','2014','2013')
*/

WHERE pm.EffStatus = 'A'
  --AND pm.pin NOT LIKE 'E%'
  AND pm.PropClassDescr LIKE '%020%'
    AND pm.PropClassDescr LIKE '%030%'
      AND pm.PropClassDescr LIKE '%032%'
        AND pm.PropClassDescr LIKE '%022%'
          AND pm.PropClassDescr LIKE '%060%'
            AND pm.PropClassDescr LIKE '%070%'
              AND pm.PropClassDescr LIKE '%090%'
...
Order By [ClassCD], [PIN], [SitusCity];
...
FROM CadValueTypeAmount_V AS cv -- ON pm.lrsn = cv.RevObjId
WHERE cv.AssessmentYear IN ('2023','2022')
--,'2022','2021','2020','2019','2018','2017','2016','2015','2014','2013')
--AND cv.ValueTypeDescr = 'Net Taxable Value'
--AND cv.PIN LIKE 'E%'
--AND cv.CadRollDescr LIKE '2023 Annual Personal Property'
