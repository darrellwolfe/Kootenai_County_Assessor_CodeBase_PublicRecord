...
,SUM(cadtotal.Cadaster_Value) AS AssesedTotal_SUM
,MEDIAN(cadtotal.Cadaster_Value) AS AssesedTotal_Median
,AVERAGE(cadtotal.Cadaster_Value) AS AssesedTotal_Average
